...
const Select: React.FC<SelectProps> = (props: ScopedProps<SelectProps>) => {
  ...
  // Default to true for SSR form event bubbling, but allow disabling via enableFormControl.
  // Use nullish coalescing to prevent empty string from triggering form control behavior.
  const isFormControl =
    enableFormControl === false ? false : trigger ? (form ?? !!trigger.closest('form')) : true;
